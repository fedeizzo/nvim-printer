...
local _2amodule_name_2a = "nvim-printer.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("nvim-printer.aniseed.core"), autoload("nvim-printer.aniseed.compile"), autoload("nvim-printer.aniseed.fennel"), autoload("nvim-printer.aniseed.fs"), autoload("nvim-printer.aniseed.nvim")
