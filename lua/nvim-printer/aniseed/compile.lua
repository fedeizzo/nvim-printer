...
local _2amodule_name_2a = "nvim-printer.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("nvim-printer.aniseed.core"), autoload("nvim-printer.aniseed.fennel"), autoload("nvim-printer.aniseed.fs"), autoload("nvim-printer.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function macros_prefix(code, opts)
  local macros_module = "nvim-printer.aniseed.macros"
  local filename
  do
