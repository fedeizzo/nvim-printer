...
local _2amodule_name_2a = "nvim-printer.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("nvim-printer.aniseed.core"), autoload("nvim-printer.aniseed.fs"), autoload("nvim-printer.aniseed.nvim"), autoload("nvim-printer.aniseed.string")
...
local function impl()
  local compiler = require("nvim-printer.aniseed.deps.fennel")
