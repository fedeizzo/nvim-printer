...
local _2amodule_name_2a = "nvim-printer.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("nvim-printer.aniseed.compile"), autoload("nvim-printer.aniseed.fennel"), autoload("nvim-printer.aniseed.fs"), autoload("nvim-printer.aniseed.nvim")
